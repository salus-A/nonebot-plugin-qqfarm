以下是完整的 README.md 自述文件，适合提交到 GitHub 和 PyPI：
...
本插件基于 [NoneBot2](https://nonebot.dev/) 和 OneBot V11 协议，对接 [QQFarm Bot UI](https://github.com/jiongbao/QQFarm-Bot-UI) 后端 API，实现农场账号的远程管理、自动化执行和状态通知。
...
后端项目 https://github.com/jiongbao/QQFarm-Bot-UI
